...
For writing the implementation and unit tests for your new command, it may be helpful to [look at previously created commands](https://github.com/leoverto/mumbledj/blob/master/commands).
...
For writing the implementation for your new service, it may be helpful to [look at previously created service wrappers](https://github.com/leoverto/mumbledj/blob/master/services).
